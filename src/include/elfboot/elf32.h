...
struct elf32_shdr *elf32_get_shdr_by_index(struct elf32_hdr *elf32_hdr,
	int index);

char *elf32_get_shdr_strtab(struct elf32_hdr *elf32_hdr);

char *elf32_get_shdr_name(struct elf32_hdr *elf32_hdr,
	struct elf32_shdr *elf32_shdr);

struct elf32_shdr *elf32_get_shdr_by_name(struct elf32_hdr *elf32_hdr,
	const char *name);
