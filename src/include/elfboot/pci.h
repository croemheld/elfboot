...
#define PCI_CLASS_RAID 					\
	PCI_DEVICE_CLASS(PCI_CLASS_STORAGE, PCI_SUBCLASS_STORAGE_RAID, 0x00)

#define PCI_CLASS_SATA 					\
	PCI_DEVICE_CLASS(PCI_CLASS_STORAGE, PCI_SUBCLASS_STORAGE_SATA, 0x01)
